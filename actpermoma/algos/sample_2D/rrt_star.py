...
class RrtStar:
    def __init__(self, x_start, x_goal, step_len,
                 goal_sample_rate, search_radius, iter_max, x_range=50, y_range=30, obs_coords=None):
        ...
        self.env = env.Env(x_range, y_range, obs_coords)
        self.plotting = plotting.Plotting(x_start, x_goal, Env=self.env)
    ...
    def planning(self, plotting=False):
...
def main():
    ...
    rrt_star.planning(plotting=True)
